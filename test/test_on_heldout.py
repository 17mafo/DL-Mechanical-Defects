...
def main():
    ...
    parser.add_argument("--models_dir", type=str, default="../model_training/finished_models")
    parser.add_argument("--heldout_root", type=str, default="../dataset_creation/processed_images")
    parser.add_argument("--image_type", type=str, default="initial", choices=["initial", "outer_rim", "background"])
